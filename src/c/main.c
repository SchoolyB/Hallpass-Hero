...
int main(void)
{
  ...
  else if (foundSettingsConfig == FALSE)
  {
    ...
    // TODO need to create a function that runs specifically on main startup that checks for the key value pairs in the settings.config file and sets the programSettings struct values to the values found in the settings.config file rather than hardcoding them into the program
